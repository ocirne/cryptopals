...
//    IV = secrets.token_ByteArray(BLOCK_SIZE)
//
//    fun __init__() {
//        plain_text = base64.b64decode(random.choice(SECRETS))
//
//    fun encrypt() {
//        aes = AES.new(KEY, AES.MODE_CBC, IV)
//        return ByteArray(aes.encrypt(padding(plain_text))), IV
//
//    fun decrypt(ciphertext: ByteArray, iv: ByteArray = IV) {
//        aes = AES.new(KEY, AES.MODE_CBC, iv)
//        plain_text = aes.decrypt(ciphertext)
//        return strip_padding(plain_text)
//
//
//// TODO refactor, only one ByteArray changes
//fun modify(chunk: ByteArray, known: ByteArray, block_end: int, c: int) {
//    ct = bytearray(chunk)
//    t = len(known) + 1
//    for i in range(t - 1) {
...
//
//
//fun decrypt(oracle: Oracle17, ciphertext: ByteArray, nth: int, iv: ByteArray = None) {
//    known = bytearray()
...
//            known.append(cc[-1])
//    return ByteArray(reversed(known))
//
//
//fun challenge17() {
//    """
